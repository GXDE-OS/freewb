...
void PyEngine::collectCandidatesForPrefix(const std::string &prefix, const std::unordered_map<std::string, std::vector<std::string>> &dict, std::vector<std::string> &out)
{
...
void PyEngine::loadDictionary()
{
    ...
    FREEWB_DEBUG("py attach tableName={}\ntableInfo={}\ntableCreateTime={}\nstrEndKeys={}\nstrSpecialKeys={}\nstrCodeType={}\nstrStraightUPKeys={}\ninputCodeLen={}\ncWildChar={}\nbRule={}\niCodeLength={}\nrecordCount={}", tableName_, tableInfo_, tableCreateTime_, strEndKeys_, strSpecialKeys_,
                 strCodeType_, strStraightUPKeys_, inputCodeLen, cWildChar_, bRule_, iCodeLength_, recordCount_);
}
