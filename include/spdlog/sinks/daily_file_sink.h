...
struct daily_filename_calculator
{
    ...
    static filename_t calc_filename(const filename_t &filename, const tm &now_tm)
    {
        ...
        return fmt::format(SPDLOG_FILENAME_T("{}_{:04d}-{:02d}-{:02d}{}"), basename, now_tm.tm_year + 1900, now_tm.tm_mon + 1,
                           now_tm.tm_mday, ext);
    }
};
...
public:
    ...
    daily_file_sink(filename_t base_filename, int rotation_hour, int rotation_minute, bool truncate = false,
        ...
        : base_filename_(std::move(base_filename)), rotation_h_(rotation_hour), rotation_m_(rotation_minute), truncate_(truncate),
